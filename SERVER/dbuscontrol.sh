...
;;
*)
echo "usage: $0 status|pause|stop|seek|volumeup|volumedown|setposition [position in microseconds]|hidevideo|unhidevideo|togglesubtitles|action [int action see KeyConfig.h]|hidesubtitles|showsubtitles|setvideopos [x1 y1 x2 y2]" >&2
exit 1
;;
esac